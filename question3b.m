...
test_accuracy = zeros([length(epochs),1]);
train_accuracy = zeros([length(epochs),1]);
for i = 1:length(epochs)
    net = train_seq(train_x,train_y,epochs(i));
...
function net = train_seq(x,y,epochs )
 net = perceptron;
